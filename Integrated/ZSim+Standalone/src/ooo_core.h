...
class OOOCore : public Core {
    private:
        ...
        // 
        bool qsEnable;
        uint64_t qsMemLoadCycleLimit; // for QS consideration do not overpopulate memory system
        g_vector<MemObject*> mainMemory; // ponter to bandwidth--latency memory system
        uint32_t qsCounter;
    ...
    public:
        ...
        void setQsEnable();
        void setMainMemory(const g_vector<MemObject*>& _mainMemory);
