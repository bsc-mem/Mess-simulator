...
class MemObject : public GlobAlloc {
    public:
        // PIM@DRAMsim3 to get the cycles left for the PIM engine to finish
        virtual uint64_t wait_for_PIM_cycles(){printf("memory_hierarchy.h: cycles left for the PIM engine. Wrong\n"); return 0;}
